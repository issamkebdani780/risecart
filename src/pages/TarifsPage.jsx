...
export const useTarifsData = () => {
 ...
 target: t('Pour les débutants qui veulent se lancer rapidement.'),
 monthlyPrice: 1900,
 annualPrice: 1500,
 popular: false,
 badge: null,
 color: 'blue',
 cta: t('Démarrer avec RiseGo'),
 features: [
 t('Boutique prête à l\'emploi'),
 t('Base solide pour démarrer'),
 t('Interface d\'administration simple'),
 t('Volume de commandes réduit'),
 t('Démarrage rapide garanti'),
 ],
 },
 {
 id: 'risecart',
 ...
 target: t('Pour les vendeurs structurés et ambitieux.'),
 monthlyPrice: 7900,
 annualPrice: 5900,
 popular: true,
 badge: t('Choix Premium'),
 color: 'amber',
 cta: t('Contacter les ventes'),
 features: [
 t('Outils d\'optimisation avancés'),
 t('Capacités d\'hébergement étendues'),
 t('Logique multi-boutique incluse'),
 t('Automatisations personnalisées'),
 t('Intégrations complètes'),
 t('Support & pilotage premium dédiés'),
 ],
 },
 {
 id: 'risebasic',
 ...
 target: t('Pour les vendeurs en pleine croissance.'),
 monthlyPrice: 3900,
 annualPrice: 2900,
 popular: false,
 badge: t('Meilleur rapport qualité/prix'),
 color: 'primary',
 cta: t('Démarrer l\'essai gratuit'),
 features: [
 t('Plus grande capacité de traitement'),
 t('Fonctionnalités marketing poussées'),
 t('Analytics et rapports enrichis'),
 t('Gestion des stocks avancée'),
 t('Meilleure flexibilité de design'),
 ],
 }
...
const comparisonRows = [
 { category: t('🏪 Boutique'), features: [
 { label: t('Boutique en ligne'), risego: true, risebasic: true, risecart: true },
 { label: t('Nombre de produits'), risego: t('100'), risebasic: t('1 000'), risecart: t('Illimité') },
 { label: t('Thèmes premium disponibles'), risego: t('3'), risebasic: t('10'), risecart: t('Tous') },
 { label: t('Domaine personnalisé'), risego: false, risebasic: true, risecart: true },
 { label: t('Éditeur visuel avancé'), risego: false, risebasic: true, risecart: true },
 { label: t('Multi-boutique'), risego: false, risebasic: false, risecart: true },
 ]},
 { category: t('📦 Commandes & Logistique'), features: [
 { label: t('Commandes / mois'), risego: t('200'), risebasic: t('2 000'), risecart: t('Illimitées') },
 { label: t('Gestion des retours'), risego: false, risebasic: true, risecart: true },
 { label: t('Impression de bons / factures'), risego: true, risebasic: true, risecart: true },
 { label: t('Suivi des expéditions'), risego: false, risebasic: true, risecart: true },
 { label: t('Gestion multi-entrepôts'), risego: false, risebasic: false, risecart: true },
 ]},
 { category: t('📊 Analytics'), features: [
 { label: t('Tableau de bord basique'), risego: true, risebasic: true, risecart: true },
 { label: t('Rapports de ventes avancés'), risego: false, risebasic: true, risecart: true },
 { label: t('Analyse du comportement client'), risego: false, risebasic: false, risecart: true },
 { label: t('Export des données (CSV/PDF)'), risego: false, risebasic: true, risecart: true },
 ]},
 { category: t('🔗 Intégrations & Écosystème'), features: [
 { label: t('Connexion RiseConfirm'), risego: false, risebasic: true, risecart: true },
 { label: t('Connexion RiseManager'), risego: false, risebasic: false, risecart: true },
 { label: t('Paiement RisePay (à venir)'), risego: true, risebasic: true, risecart: true },
 { label: t('API ouverte'), risego: false, risebasic: false, risecart: true },
 { label: t('Webhooks & automatisations'), risego: false, risebasic: false, risecart: true },
 ]},
 { category: t('🛡️ Sécurité & Support'), features: [
 { label: t('Support par email'), risego: true, risebasic: true, risecart: true },
 { label: t('Support prioritaire'), risego: false, risebasic: true, risecart: true },
 { label: t('Gestionnaire dédié'), risego: false, risebasic: false, risecart: true },
 { label: t('Sauvegardes automatiques'), risego: false, risebasic: true, risecart: true },
 { label: t('Infrastructure dédiée'), risego: false, risebasic: false, risecart: true },
 ]},
];

const faqItems = [
 {
 q: t('L\'essai gratuit inclut-il toutes les fonctionnalités ?'),
 a: t('Oui ! Pendant votre période d\'essai de 7 jours, vous accédez à l\'intégralité des fonctionnalités du plan RiseCart, sans engagement ni carte bancaire requise.'),
 },
 {
 q: t('Puis-je changer de plan après mon inscription ?'),
 a: t('Absolument. Vous pouvez monter en gamme ou changer de plan à tout moment depuis votre espace administration. Le changement est effectif immédiatement, au prorata de votre abonnement.'),
 },
 {
 q: t('Y a-t-il des frais de transaction sur les ventes ?'),
 a: t('Non. RiseCart ne prélève aucun frais de commission sur vos ventes. Vous conservez 100% de vos revenus. Seul votre prestataire de paiement peut appliquer ses propres commissions.'),
 },
 {
 q: t('Comment fonctionne la facturation annuelle ?'),
 a: t('En optant pour l\'abonnement annuel, vous payez en une seule fois pour 12 mois et profitez d\'une réduction d\'environ 20% par rapport au tarif mensuel.'),
 },
 {
 q: t('Y a-t-il une réduction de lancement ?'),
 a: t('Oui ! Pour les premiers inscrits, nous offrons 2 mois offerts sur tout abonnement annuel. Cette offre est limitée, ne la ratez pas.'),
 },
 {
 q: t('Puis-je annuler à tout moment ?'),
 a: t('Bien entendu. Aucun engagement à long terme. Vous pouvez annuler votre abonnement à tout moment depuis votre tableau de bord, sans frais supplémentaire.'),
 },
];

  return { plans, comparisonRows, faqItems };
};
...
const FaqItem = ({ q, a }) => {
 ...
 <button
 onClick={() => setOpen(o => !o)}
 className="w-full flex items-center justify-between gap-4 px-6 py-5 text-start group"
 >
...
const TarifsPage = () => {
  const { t } = useTranslation();
  const { plans, comparisonRows, faqItems } = useTarifsData();
 ...
 <span className="text-[11px] font-bold text-emerald-600 dark:text-emerald-400 tracking-tight">{t("7 jours d'essai gratuit · Aucune carte requise")}</span>
 </div>
 <h1 className="text-5xl lg:text-7xl font-black text-slate-900 dark:text-white tracking-tight mb-6 leading-tight">
 {t("Des tarifs")} <span className="text-primary italic">{t("simples")}</span>,<br className="hidden sm:block" /> {t("une croissance réelle.")}
 </h1>
 <p className="text-lg lg:text-xl text-slate-500 dark:text-slate-400 font-medium mb-14 max-w-2xl mx-auto">
 {t("Choisissez l'offre adaptée à votre étape et évoluez à votre rythme. Pas de surprise, pas de commission sur vos ventes.")}
 </p>
 ...
 <span className={`text-sm font-bold ${plan.popular ? 'text-slate-400' : 'text-slate-400'}`}>{t("DA/mois")}</span>
 </div>
 {isAnnual ? (
 <p className="text-xs text-emerald-400 font-bold mt-1.5">{t("Facturé annuellement · Économie de 20%")}</p>
 ) : (
 <p className={`text-xs mt-1.5 font-medium ${plan.popular ? 'text-slate-500' : 'text-slate-400'}`}>{t("Facturé mensuellement")}</p>
 )}
 </div>
 ...
 <div className="mt-16 max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-4 p-5 bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 rounded-2xl text-center sm:text-start">
 <Tag size={20} className="text-amber-500 shrink-0" />
 <p className="text-sm font-bold text-amber-800 dark:text-amber-300">
 🎉 <strong>{t("Offre de lancement :")}</strong> {t("Obtenez")} <strong>{t("2 mois offerts")}</strong> {t("sur tout abonnement annuel pour les 100 premiers inscrits. Valable jusqu'à épuisement des places.")}
 </p>
 ...
 <p className="text-[10px] font-black text-primary uppercase tracking-[0.3em] mb-4">{t("Comparatif complet")}</p>
 <h2 className="text-3xl lg:text-5xl font-black text-slate-900 dark:text-white tracking-tight">{t("Ce que chaque plan")}<br/><span className="text-slate-400 dark:text-slate-500 font-medium">{t("inclut exactement.")}</span></h2>
 </div>
 ...
 <th className="text-start px-6 py-5 w-[40%]">
 <span className="text-[10px] font-black uppercase tracking-widest text-slate-400">{t("Fonctionnalité")}</span>
 </th>
 {plans.map(p => (
 ...
 <span className="text-[11px] font-bold text-emerald-400 tracking-tight">{t("100% gratuit · Sans carte bancaire")}</span>
 </div>
 <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight mb-5">{t("Testez RiseCart")}<br/><span className="text-primary">{t("7 jours gratuitement.")}</span></h2>
 ...
 <p className="text-[10px] font-black text-primary uppercase tracking-[0.3em] mb-4">{t("Questions fréquentes")}</p>
 <h2 className="text-3xl lg:text-4xl font-black text-slate-900 dark:text-white tracking-tight">{t("Tout savoir sur nos tarifs")}<br/><span className="text-slate-400 dark:text-slate-500 font-medium">{t("avant de vous lancer.")}</span></h2>
 </div>

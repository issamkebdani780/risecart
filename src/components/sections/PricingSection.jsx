    ...
    const plans = [
        {
            ...
            target: t('Pour les débutants qui veulent se lancer.'),
            monthlyPrice: '1,900',
            annualPrice: '1,500',
            popular: false,
            features: [
        ...
        },
        {
            ...
            features: [
                ...
                t('Intégrations'),
                t('Pilotage et support premium dédiés')
            ],
        ...
        },
        {
            ...
            target: t('Pour les vendeurs en croissance.'),
            monthlyPrice: '3,900',
            annualPrice: '2,900',
            popular: false,
            features: [
                ...
                t('Analytics et rapports plus riches'),
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16 space-y-6">
                    ...
                    <h2 className="text-4xl lg:text-5xl font-black text-slate-900 dark:text-white tracking-tight animate-slide-up" style={{ animationDelay: '0.1s' }}>
                        {t("Une offre adaptée à chaque étape de votre")} <span className="text-primary">{t("Croissance")}</span>
                    </h2>
                ...
                <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                    {plans.map((plan, index) => (
                        <div
                            key={plan.id}
                            className={`relative flex flex-col p-8 rounded-3xl transition-all duration-300 animate-slide-up ${plan.popular
                        ...
                        >
                            ...
                            <div className="mb-8 p-6 rounded-2xl bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800">
                                ...
                                {isAnnual && (
                                    <p className="text-xs text-emerald-500 font-bold mt-2">
                                        {t("Facturé annuellement (Économie de 20%)")}
                                    </p>
                                )}
                                {!isAnnual && (
                                    <p className="text-xs text-slate-400 dark:text-slate-500 mt-2 font-medium">
                                        {t("Facturé mensuellement")}
                                    </p>
                                )}
                            </div>
                            ...
                            {/* CTA */}
                            <button
                                className={`mt-10 w-full py-4 px-6 rounded-2xl font-black tracking-wide flex items-center justify-center gap-2 transition-all active:scale-95 ${plan.popular

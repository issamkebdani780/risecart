  ...
  const reasons = [
    {
      ...
      desc: 'Lance ta boutique opérationnelle en quelques clics sans compétences techniques.',
      icon: <Rocket className="text-primary" />,
    },
    {
      title: 'Gestion centralisée',
      desc: 'Commandes, produits et suivi pilotés depuis une seule interface intuitive.',
      icon: <Layout className="text-primary" />,
    },
    {
      title: 'Vision business',
      desc: 'Analyse tes performances en temps réel pour prendre les meilleures décisions.',
      icon: <BarChart3 className="text-primary" />,
    },
    {
      title: 'Écosystème connecté',
      desc: 'Intégration native avec RiseManager, RiseConfirm et notre réseau logistique.',
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2 space-y-8">
            ...
            <h2 className="text-4xl lg:text-5xl font-extrabold text-slate-900 dark:text-white leading-[1.2] tracking-tight">
              Bien plus qu'un simple <span className="text-primary italic">website builder</span>.
            </h2>
            <p className="text-slate-500 dark:text-slate-400 text-lg max-w-xl text-balance font-medium">
              RiseCart est conçu pour transformer votre activité e-commerce en un véritable système de croissance. Nous fournissons les outils nécessaires pour structurer votre business de A à Z.
            </p>
            <div className="pt-4">
               <button 
               ...
               >
                  Découvrir tous les avantages <div className="p-2 rounded-full bg-white dark:bg-slate-800 group-hover:bg-primary group-hover:text-white transition-all shadow-sm border border-slate-100 dark:border-slate-800"><ArrowRight size={20} className="rtl:rotate-180" /></div>
               </button>
            </div>
          </div>

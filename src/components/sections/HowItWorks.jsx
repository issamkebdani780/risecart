...
const HowItWorks = () => {
 ...
 { 
 number: '01', 
 title: t('Créer son compte'), 
 desc: t('Inscription rapide pour accéder à votre espace commerçant.'),
 icon: <UserPlus size={24} />
 },
 { 
 number: '02', 
 title: t('Configurer sa boutique'), 
 desc: t('Personnalisez le design selon votre marque en quelques clics.'),
 icon: <Settings size={24} />
 },
 { 
 number: '03', 
 title: t('Ajouter ses produits'), 
 desc: t('Importez votre catalogue avec images et descriptions détaillées.'),
 icon: <PackagePlus size={24} />
 },
 { 
 number: '04', 
 title: t('Recevoir ses commandes'), 
 desc: t('Suivez en direct l\'arrivée de vos premiers clients.'),
 icon: <ShoppingBag size={24} />
 },
 { 
 number: '05', 
 title: t('Piloter et scaler'), 
 desc: t('Analysez vos datas et optimisez vos stratégies de vente.'),
 ...
 {t("Un parcours simple et fluide, conçu pour vous faire vendre le plus rapidement possible.")}
 </p>
 </div>
 ...
 {/* Content Card */}
 <div className={`md:w-1/2 ${isEven ? 'md:ps-16' : 'md:pe-16'} ps-0`}>

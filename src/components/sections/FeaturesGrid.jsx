...
const FeaturesGrid = () => {
 ...
 const features = [
 {
 title: t('Création de boutique'),
 desc: t('Design moderne, ultra-responsive et optimisé pour la conversion sur mobile et desktop.'),
 icon: <ShoppingBag size={24} />,
 accent: 'primary'
 },
 {
 title: t('Gestion des produits'),
 desc: t('Catalogue complet avec variantes, gestion des stocks et fiches produits haute définition.'),
 icon: <Box size={24} />,
 accent: 'secondary'
 },
 {
 title: t('Gestion des commandes'),
 desc: t('Pipeline de traitement fluide avec filtres avancés et historique complet par client.'),
 icon: <ClipboardList size={24} />,
 accent: 'primary'
 },
 {
 title: t('Statistiques & Analytics'),
 desc: t('Tableaux de bord précis pour suivre vos ventes, taux de conversion et panier moyen.'),
 icon: <PieChart size={24} />,
 accent: 'secondary'
 },
 {
 title: t('Écosystème Connecté'),
 desc: t('Synchronisation parfaite avec RiseManager et RiseConfirm pour un pilotage total.'),
 icon: <Share2 size={24} />,
 accent: 'primary'
 },
 {
 title: t('Optimisation Scalability'),
 desc: t('Infrastructure pensée pour supporter vos pics de trafic et l\'augmentation de vos volumes.'),
 ...
 <h2 className="text-4xl lg:text-5xl font-extrabold text-slate-900 dark:text-white mb-6 tracking-tight">{t("Tout ce dont tu as besoin pour")} <span className="text-primary italic">{t("dominer")}</span> {t("le marché.")}</h2>
 <p className="text-slate-500 dark:text-slate-400 text-lg max-w-2xl mx-auto font-medium">
 {t("Nous avons regroupé toutes les fonctionnalités essentielles dans une interface unique et puissante.")}
 </p>
 </div>

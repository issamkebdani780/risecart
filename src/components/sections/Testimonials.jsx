       ...
       <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl lg:text-6xl font-extrabold text-slate-900 dark:text-white mb-6 tracking-tight">
               Ils ne reviendront plus <span className="text-primary italic">en arrière</span>.
            </h2>
            <p className="text-lg text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto">
               Découvrez comment RiseCart transforme le quotidien de centaines de vendeurs ambitieux.
            </p>
          </div>

...
const TrustBand = () => {
 ...
 const stats = [
 { label: t('Vendeurs Actifs'), end: 2500, suffix: '+' },
 { label: t('Commandes / Mois'), end: 350, suffix: 'K+' },
 { label: t('Taux Succès'), end: 94, suffix: '%' },
 ];
 ...
 <div key={index} className="flex items-center gap-4 px-10 border-e border-slate-200 dark:border-slate-800 last:border-e-0">
 ...
 <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 group text-center sm:text-start">
 <Logo 
 showText={false} 
 ...
 {t("Propulsé par")} <span className="text-primary italic">{t("RiseGroup")}</span>
 </h3>
 </div>
 </div>

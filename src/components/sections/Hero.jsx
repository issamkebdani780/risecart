          ...
          <div className="flex flex-col items-start text-left max-w-2xl mx-auto lg:mx-0">
            ...
            <div className="flex flex-wrap gap-x-8 gap-y-3 animate-slide-up" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="flex items-center gap-2 text-slate-400 dark:text-slate-500">
                ...
                <span className="text-xs font-bold uppercase tracking-wider">Mise en route rapide</span>
              </div>
              <div className="flex items-center gap-2 text-slate-400 dark:text-slate-500">
                <Rocket size={16} className="text-primary" />
                <span className="text-xs font-bold uppercase tracking-wider">Conçu pour l’e-commerce moderne</span>
              </div>
            </div>
          </div>
                        ...
                        <div className="h-full flex gap-3 xs:gap-4 flex-col xs:flex-row">
                          ...
                          <div className="flex-1 bg-slate-50 dark:bg-slate-900 rounded-2xl xs:rounded-3xl border-2 border-dashed border-slate-200 dark:border-slate-800 p-4 flex flex-col relative overflow-hidden animate-fade-in" key={builderSubTab}>
                            ...
                            <div className="flex-1 overflow-y-auto no-scrollbar scroll-smooth flex flex-col gap-3 min-h-0 w-full relative z-0 pb-16">
                              ...
                              {builderSubTab === 'styles' && (
                                <div className="flex-1 flex flex-col items-center justify-center w-full h-full text-slate-300 dark:text-slate-600 min-h-[150px]">
                                  ...
                                  <p className="text-[10px] font-black uppercase tracking-widest opacity-50">Couleurs du thème</p>
                              ...
                              {builderSubTab === 'polices' && (
                                <div className="flex-1 flex flex-col items-center justify-center w-full h-full text-slate-300 dark:text-slate-600 min-h-[150px]">
                                  ...
                                  <p className="text-[10px] font-black uppercase tracking-widest opacity-50">Typographie globale</p>
                                  <div className="flex flex-col gap-2 mt-4 items-center">
                                    <div className="text-xs font-serif font-black text-slate-900 dark:text-white border border-slate-200 dark:border-slate-800 px-3 py-1 rounded bg-white dark:bg-slate-950">Playfair Display</div>
                                    <div className="text-xs font-sans text-slate-400">Inter</div>
                                  </div>
                                </div>
                              )}
                            </div>
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-4 bg-slate-50 dark:bg-slate-900 z-10">
                              <button className="w-full py-3 bg-primary text-white text-[10px] xs:text-xs font-black uppercase rounded-2xl hover:bg-primary/90 transition-colors shadow-lg shadow-primary/20">Enregistrer</button>
                            </div>
                          </div>
                        </div>
                      )}

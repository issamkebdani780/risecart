...
const Footer = () => {
 ...
 {t("La plateforme E-commerce intelligente")}
 </p>
 ...
 <ul className="space-y-4">
 {['RiseManager', 'RiseCart', 'RiseConfirm', 'FBR Network', 'RiseAcademy', 'RisePay'].map(link => (
 <li key={link}>
 ...
 <div className="text-sm font-bold text-slate-600 dark:text-white group-hover:text-primary transition-colors truncate">{t("Oran, Algeria")}</div>
 </div>
 </a>
 ...
 <div className="text-xs sm:text-sm font-bold text-slate-600 dark:text-white group-hover:text-primary transition-colors truncate">{t("contact@risemanager.com")}</div>
 </div>
 </a>
 ...
 <div className="min-w-0">
 <div className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase leading-none mb-1">{t("Support")}</div>
 ...
 { label: t("Support Local (DZ)"), icon: "M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" },
 ...
 { label: t("Infrastructure Sérieuse"), icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5" }
 ].map((signal, i) => (
 ...
 <div className="text-[11px] font-black text-slate-800 dark:text-slate-200 uppercase tracking-widest text-center lg:text-start">{t(signal.label)}</div>
 </div>
 ))}
 </div>
 ...
 &copy; {new Date().getFullYear()} {t("Propulsé par")} <span className="text-primary italic">{t("RiseGroup")}</span>
 </div>
